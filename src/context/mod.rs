...
pub trait ContextClient<'ctx>: private::SealedContext<'ctx> {
    ...
    /// Create a service client. The service client is generated by the [`restate_sdk_macros::service`] macro with the same name of the struct suffixed with `Client`.
    ///
    /// ```rust,no_run
    /// # use std::time::Duration;
    /// # use restate_sdk::prelude::*;
    ...
    /// Create an object client. The object client is generated by the [`restate_sdk_macros::object`] macro with the same name of the struct suffixed with `Client`.
    ///
    /// ```rust,no_run
    /// # use std::time::Duration;
    /// # use restate_sdk::prelude::*;
    ...
    /// Create an workflow client. The workflow client is generated by the [`restate_sdk_macros::workflow`] macro with the same name of the struct suffixed with `Client`.
    ///
    /// ```rust,no_run
    /// # use std::time::Duration;
    /// # use restate_sdk::prelude::*;
