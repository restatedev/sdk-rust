...
impl Builder {
    ...
    #[cfg(feature = "lambda")]
    pub fn build_lambda(mut self) -> crate::lambda::LambdaEndpoint {
        self.discovery.protocol_mode = Some(crate::discovery::ProtocolMode::RequestResponse);
        crate::lambda::LambdaEndpoint::new(self.build())
    }
}
